        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                ...
                move_uploaded_file($file_tmp2, 'bukti/'.$nama_gambar_baru2); //memindah file gambar ke folder gambar
                  ...
                  $query = "INSERT INTO daftar (dfr_no, dfr_tanggal, dfr_password,
                    dft_nama, dfr_jekel, dfr_tmp_lahir, dfr_tgl_lahir, dft_agama, dfr_anak_dr, dfr_nisn, dfr_asal_sekolah, dfr_almt_sekolah, dfr_pas_photo,
                    ...
                    '$nama_gambar_baru', '$nilai_mm', '$nilai_indo', '$nilai_eng', '$nilai_ipa', '$nilai_ips', '$nama_ayah', '$nama_ibu', '$alamat_ortu', '$notelp', '$status', '$nama_gambar_baru2')";
