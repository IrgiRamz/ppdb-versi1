...
$query = "UPDATE daftar SET dft_nama='$nama', dfr_jekel='$jekel', dfr_tmp_lahir='$tempat_lahir', dfr_tgl_lahir='$tanggal_lahir', dft_agama='$agama', dfr_anak_dr='$anak_dari', dfr_nisn='$nisn', dfr_asal_sekolah='$asal_sekolah', dfr_almt_sekolah='$alamat_sekolah',
