    ...
    <form action="adm_pendaftar_update.php" onsubmit="return validation(this)" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="has-validation-callback">
      <table>
        <tbody>
      	...
      	<tr>
      		<td>Nama Lengkap</td>
      		<td colspan="2"><input class="form-control" name="nama" data-validation="required" type="text" value="<?php echo $d['dft_nama']; ?>"></td>
      	</tr>
  			<tr>
  				<td>Jenis Kelamin</td>
  			...
  			<tr>
  				...
  				<td colspan="2">
    				<select class="form-control" name="agama" data-validation="required" type="text">
      				<option value="1" <?php if ($d['dft_agama']=="1") { echo "selected=\"selected\""; } ?>>Islam</option>
      				<option value="2" <?php if ($d['dft_agama']=="2") { echo "selected=\"selected\""; } ?>>Protestan</option>
              <option value="3" <?php if ($d['dft_agama']=="3") { echo "selected=\"selected\""; } ?>>Katolik</option>
              <option value="4" <?php if ($d['dft_agama']=="4") { echo "selected=\"selected\""; } ?>>Hindu</option>
              <option value="5" <?php if ($d['dft_agama']=="5") { echo "selected=\"selected\""; } ?>>Budha</option>
              <option value="6" <?php if ($d['dft_agama']=="6") { echo "selected=\"selected\""; } ?>>Konghu Cho</option>
    				</select>
          </td>
  			</tr>
  			<tr>
