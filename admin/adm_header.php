	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header" style="padding-left:30px;">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">MENU</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
					  <a class="navbar-brand" href="#"><img src="../assets/img/logosma.png" alt="" width="21"></a>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li>
							<a href="adm_beranda.php">Beranda</a>
						</li>
						<li>
							<a href="adm_alur.php">Alur</a>
						</li>
						<li>
							<a href="adm_jadwal.php">Jadwal</a>
						</li>
						<li>
							<a href="adm_persyaratan.php">Persyaratan</a>
						</li>
            <li class="dropdown">
              <a data-toggle="dropdown" class="dropdown-toggle" href="#">Daftar Peserta</a>
								<ul class="dropdown-menu">
									<li>
										<a href="adm_all_peserta.php">Keseluruhan</a>
									</li>
									<li>
										<a href="adm_peringkat_lolos.php">Peringkat Lolos</a>
									</li>
                  <li>
										<a href="adm_peringkat_tdk_lolos.php">Peringkat Tidak Lolos</a>
									</li>
								</ul>
						</li>
						<li></li>
          ...
          <ul class="nav navbar-nav navbar-right">
						...
						<li style="padding-right:30px"> <a href="adm_logout.php">Logout</a></li>
          </ul>
				</div>
			</nav>
